#ifndef __ARD_PS2_HOST_H__
#define __ARD_PS2_HOST_H__
...
#define WAIT_FOR_NEXT_LOW(TIME) WAIT_HIGH(P_CLK, TIME) WAIT_LOW(P_CLK, TIME)
#define WAIT_FOR_NEXT_HIGH(TIME) WAIT_LOW(P_CLK, TIME) WAIT_HIGH(P_CLK, TIME)
